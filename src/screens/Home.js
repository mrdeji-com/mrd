                ...
                <header>
                    ...
                    <div className={widget ? "widget active" : "widget"} onMouseEnter={setWidget(true)} onMouseLeave={() => setWidget(false)}>
                        ...
                        <div className="widget-body">
                            ...
                            <span><i class="fas fa-phone-alt"></i>Call 07006733540</span>
                            <a href="https://chatwith.io/s/mrdeji-com" target="_blank"><span><i class="far fa-comment-alt"></i>Click to Chat</span></a>
                            <Link to="/schedule_session"><span><i class="far fa-calendar-alt"></i>Schedule a Meeting</span></Link>
                        </div>
                    </div>
                </header>
                {/* begin  */}
                <section className="begin">
                    <div className="container">
                        <div className="row">
                            ...
                            <div data-aos="fade-right" className="col-lg-6 col-md-6 col-sm-6 p-100">
                                <div className="center-content">
                                    <h1>You can begin to <span className="emphasis">deliver your products and services</span> using
                                        digital channels</h1>
                                    <p>As our world evolves, the need for digital access to services and products is on the
                                        rise. Customers/clients are looking for seamless ways to receive your services
                                        and products with less complexities and
                                        cost.
                                    </p>
                                    <p>Refer to some of our services that speak to your business goals and objectives.</p>
                                    <div>
                                        <Link to="/services" className="button" data-aos="zoom-in">See Our Services</Link>
                                    </div>
                                </div>
                            </div>
                            <div data-aos="fade-left" className="col-lg-5 col-md-6 col-sm-6">
                                <img src={require("../img/7mvphy38 1.png").default} className="img-fluid mx-auto d-block" alt="alt" />
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="container">
                            <div className="row">
                                <div data-aos="fade-up" className="col-lg-6 col-md-6 col-sm-6">
                                    <img src={require("../img/Layer 0 1.png").default} className="img-fluid mx-auto d-block" alt="alt" />
                                </div>
                                <div className="col-lg-6 col-md-6 col-sm-6 center-content">
                                    <div className="text-wrapper">
                                        <h1>Have an <span className="emphasis">idea that can translate</span> into the next big tech
                                            product?</h1>
                                        <p>Reach out to us to build it for you</p>
                                        <Link to="/schedule_session" className="button" data-aos="flip-left" >Schedule a Strategy Session</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <Link to="/digital_content">
                                        <div className="service">
                                            <div className="row service-header">
                                                <div className="col-2">
                                                    <img src={require("../img/content 2.png").default} alt="alt" />
                                                </div>
                                ...
                                <div className="col-lg-6 col-md-6" data-aos="fade-up">
                                    <Link to="/mobile_app_development">
                                        <div className="service">
                                            <div className="row service-header">
                                                <div className="col-2">
                                                    <img src={require("../img/user-interface (1) 1.png").default} alt="alt" />
                                                </div>
                                                <div className="col-10">
                                ...
                                <div className="col-lg-6 col-md-6" data-aos="fade-up">
                                    <Link to="/idea_mapping">
                                        <div className="service">
                                            <div className="row service-header">
                                                <div className="col-2">
                                                    <img src={require("../img/design-process (1) 1.png").default} alt="alt" />
                                                </div>
                                                <div className="col-10">
                                                    <h3>Idea Mapping</h3>
                                                </div>
                                ...
                                <div className="col-lg-6 col-md-6" data-aos="fade-up">
                                    <Link to="ecommerce_development">
                                        <div className="service">
                                            <div className="row service-header">
                                                <div className="col-2">
                                                    <img src={require("../img/shopping 1.png").default} alt="alt" />
                                                </div>
                                                <div className="col-10">
                                ...
                                <div className="col-lg-6 col-md-6" data-aos="fade-up">
                                    <Link to="payment_integration_services">
                                        <div className="service">
                                            <div className="row service-header">
                                                <div className="col-2">
                                                    <img src={require("../img/debit-card 1.png").default} alt="alt" />
                                                </div>
                                                <div className="col-10">
                                ...
                                <div className="col-lg-6 col-md-6" data-aos="fade-up">
                                    <Link to="/security_services">
                                        <div className="service">
                                            <div className="row service-header">
                                                <div className="col-2">
                                                    <img src={require("../img/shield 1.png").default} alt="alt" />
                                                </div>
                                                <div className="col-10">
                                ...
                                <div className="col-lg-6 col-md-6" data-aos="fade-up">
                                    <Link to="/web_application_development">
                                        <div className="service">
                                            <div className="row service-header">
                                                <div className="col-2">
                                                    <img src={require("../img/programming (2) 1.png").default} alt="alt" />
                                                </div>
                                                <div className="col-10">
                                ...
                                <div className="col-lg-6 col-md-6" data-aos="fade-up">
                                    <Link to="/web_design_services">
                                        <div className="service">
                                            <div className="row service-header">
                                                <div className="col-2">
                                                    <img src={require("../img/website 1.png").default} alt="alt" />
                                                </div>
                                                <div className="col-10">
                                ...
                                <div className="col-lg-6 col-md-6" data-aos="fade-up">
                                    <Link to="/coorporate_design_services">
                                        <div className="service">
                                            <div className="row service-header">
                                                <div className="col-2">
                                                    <img src={require("../img/logo-design 1.png").default} alt="alt" />
                                                </div>
                                                <div className="col-10">
                                ...
                                <div className="col-lg-6 col-md-6" data-aos="fade-up">
                                    <Link to="/value_added_services">
                                        <div className="service">
                                            <div className="row service-header">
                                                <div className="col-2">
                                                    <img src={require("../img/high-value 1.png").default} alt="alt" />
                                                </div>
                                                <div className="col-10">
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-6 col-md-6 col-sm-6" data-aos="fade-right">
                                    <img src={require("../img/goal 1.png").default} className="img-fluid mx-auto d-block" alt="alt" />
                                </div>
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    ...
                                    <div>
                                        <Link to="/join" data-aos="zoom-in" className="button">Join Our Team</Link>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="center-content col-lg-6 col-md-6">
                                ...
                                <div>
                                    <Link to="/partner" className="button" data-aos="zoom-in">Partner With Us</Link>
                                </div>
                            </div>
                            <div className="col-lg-5 col-md-6">
                                <img src={require("../img/handshake(1) 1.png").default} className="img-fluid mx-auto d-block" alt="alt" />
                            </div>
                        </div>
                    </div>
                </section>
